...
map.getView().fit([-7526363.475076, -5763472.338805, -7502574.617315, -5743023.145996], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Obras públicas en Comodoro Rivadavia | 2024 y 2025</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (385 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Visualizador web interactivo de las obras públicas realizadas en Comodoro Rivadavia durante los años 2024 y 2025. Información detallada sobre el nombre de la obra, tipo, número, barrio, acta, empresa y presupuesto. Datos extraídos de la plataforma de datos abiertos de la Municipalidad de Comodoro Rivadavia.<br />Dirección General de Modernización e Investigación Territorial. Julio, 2025.';
            }
